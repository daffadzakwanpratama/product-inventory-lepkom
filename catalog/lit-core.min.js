...
class $ extends HTMLElement {
        ...
        h =
          "function" == typeof t.converter
            ...
            : void 0 !== t.converter?.fromAttribute
              ...
              : b;
      this.m = e;
      const o = h.fromAttribute(s, t.type);
      ((this[e] = o ?? this.T?.get(e) ?? o), (this.m = null));
    }
  }
  requestUpdate(t, s, i) {
    if (void 0 !== t) {
  ...
  M(t, s, { useDefault: i, reflect: e, wrapped: h }, o) {
    (i &&
      ...
      (this.T.set(t, o ?? s ?? this[t]), !0 !== h || void 0 !== o)) ||
      (this._$AL.has(t) ||
  ...
  for (let s = 0; s < i; s++) {
    ...
    o +=
      r === V
        ? i + A
        : a >= 0
          ? (e.push(n), i.slice(0, a) + M + i.slice(a) + x + u)
          : i + x + (-2 === a ? s : u);
  }
  return [
      ...
      if (1 === e.nodeType) {
        ...
        if (e.data === k) n.push({ type: 2, index: h });
          ...
          for (; -1 !== (t = e.data.indexOf(x, t + 1)); )
            (n.push({ type: 7, index: h }), (t += x.length - 1));
        }
      h++;
    }
  }
...
class et {
  ...
  H(t) {
    ...
    for (const h of t)
      (e === s.length
        ? s.push((i = new et(this.B(U()), this.B(U()), this, this.options)))
        : (i = s[e]),
        i._$AI(h),
        e++);
